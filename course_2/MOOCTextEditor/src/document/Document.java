...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
        ...
        final ArrayList vowels = new ArrayList<>(Arrays.asList('A', 'E', 'I', 'O', 'U', 'Y', 'a', 'e', 'i', 'o', 'u', 'y'));
        ...
        if (word.charAt(word.length() - 1) == 'e' && count > 1 && !vowels.contains(word.charAt(word.length() -2)))
            count--;
